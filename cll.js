  ...
  var renderForm = function (seqix) {
      return function (v) {
          ...
          if (seqix.side instanceof RHS && v.form instanceof Plus) {
              return clickable(clss)(p(Data_Maybe.Nothing.value))([ clickable([  ])(p(new Data_Maybe.Just(Part1.value)))([ ppFormH(0)(v.form.value0) ]), Spork_Html_Core.text(" + "), clickable([  ])(p(new Data_Maybe.Just(Part2.value)))([ ppFormH(0)(v.form.value1) ]) ]);
          };
  ...
  var update = function (v) {
      return function (v1) {
          ...
          if (v1 instanceof Submit) {
              ...
              throw new Error("Failed pattern match at Main line 36, column 29 - line 38, column 49: " + [ v2.constructor.name ]);
          };
