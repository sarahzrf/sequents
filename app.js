...
(function($PS) {
  ...
  var onKeyDown = function ($13) {
      return Spork_Html_Core.on("keydown")($13);
  };
...
(function($PS) {
  ...
  var Calculus = function (Eq0, formParser, pickRule) {
      this.Eq0 = Eq0;
  ...
  var unitaggedConc = function (v) {
      ...
      throw new Error("Failed pattern match at Derivation (line 227, column 1 - line 227, column 57): " + [ v.constructor.name ]);
  };
  var intersperse = function (sep) {
      return function (arr) {
          ...
          throw new Error("Failed pattern match at Derivation (line 348, column 23 - line 351, column 59): " + [ v.constructor.name ]);
      };
  };
  ...
  var functorPickAction = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          throw new Error("Failed pattern match at Derivation (line 198, column 8 - line 198, column 56): " + [ m.constructor.name ]);
      };
  });
  var functorNodeAction = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          throw new Error("Failed pattern match at Derivation (line 249, column 8 - line 249, column 56): " + [ m.constructor.name ]);
      };
  });
  var functorExplodedSequent = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          throw new Error("Failed pattern match at Derivation (line 139, column 8 - line 139, column 66): " + [ m.constructor.name ]);
      };
  });
  ...
  var explodeNG = function (v) {
      ...
      var splitAtNew = function (forms) {
          var v1 = function (v2) {
              ...
              throw new Error("Failed pattern match at Derivation (line 150, column 1 - line 150, column 75): " + [ forms.constructor.name ]);
          };
      ...
      throw new Error("Failed pattern match at Derivation (line 152, column 3 - line 160, column 3): " + [ v2.constructor.name, v1.constructor.name ]);
  };
  ...
  var explodeG = function (v) {
      ...
      var splitAtNew = function (forms) {
          var v1 = function (v2) {
              ...
              throw new Error("Failed pattern match at Derivation (line 167, column 1 - line 167, column 73): " + [ forms.constructor.name ]);
          };
      ...
      throw new Error("Failed pattern match at Derivation (line 169, column 3 - line 177, column 3): " + [ v2.constructor.name, v1.constructor.name ]);
  };
  var enew = function (v) {
      ...
      throw new Error("Failed pattern match at Derivation (line 142, column 8 - line 146, column 23): " + [ v.constructor.name ]);
  };
  var complete = function (v) {
      ...
      throw new Error("Failed pattern match at Derivation (line 233, column 1 - line 233, column 47): " + [ v.constructor.name ]);
  };
  var clickable = function (clss) {
      return function (act) {
          ...
          return Spork_Html_Elements.span([ Spork_Html_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "clickable" ])(clss)), Spork_Html_Events.onMouseDown(function ($295) {
              return Data_Functor.map(Data_Maybe.functorMaybe)(act)(buttonFor($295));
          }) ]);
      };
  };
  var renderSequent = function (dictRenderForm) {
      return function (v) {
          var turnstile = clickable([  ])(function ($296) {
  ...
  var renderDerivation = function (dictRenderForm) {
      return function (prf) {
          var renderConc = function ($298) {
              return Data_Functor.map(Spork_Html_Core.functorHtml)(NAction.create)(renderSequent(dictRenderForm)($298));
          };
              ...
              if (prf instanceof Conclusion) {
                  return [ (function () {
                      ...
                      var conc = (function () {
                          ...
                          throw new Error("Failed pattern match at Derivation (line 340, column 18 - line 342, column 79): " + [ prf.value0.wconc.constructor.name ]);
                      })();
                      return renderConc(conc);
                  })() ];
              };
              throw new Error("Failed pattern match at Derivation (line 330, column 3 - line 343, column 26): " + [ prf.constructor.name ]);
          })());
      };
  };
  var byPart = function (x) {
      return function (y) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Derivation (line 115, column 1 - line 115, column 44): " + [ x.constructor.name, y.constructor.name, v.constructor.name ]);
          };
      };
  };
          ...
          return function ($copy_wconc) {
              ...
              function $tco_loop(dictCalculus, rule, wconc) {
                  var v = (function () {
                      ...
                      throw new Error("Failed pattern match at Derivation (line 305, column 32 - line 309, column 74): " + [ wconc.constructor.name ]);
                  })();
                  ...
                  throw new Error("Failed pattern match at Derivation (line 300, column 24 - line 304, column 57): " + [ v1.constructor.name ]);
              };
              while (!$tco_done) {
      ...
      return function (prf) {
          return function (v) {
              ...
              var v1 = function (v2) {
                  ...
                  throw new Error("Failed pattern match at Derivation (line 258, column 1 - line 259, column 46): " + [ prf.constructor.name, v.constructor.name ]);
              };
              if (v instanceof ClickedTurnstile && v.value0.button instanceof LeftButton) {
                  ...
                  if ($279.value0.length === 1 && $279.value1.length === 1) {
                      var $280 = Data_Eq.eq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                          return "tag";
                      }))(Data_Eq.eqUnit))()(new Data_Symbol.IsSymbol(function () {
                          return "form";
                      }))(dictCalculus.Eq0())))($279["value0"][0])($279["value1"][0]);
                      if ($280) {
  ...
  exports["Instantiating"] = Instantiating;
  ...
  exports["functorTaggedSequent"] = functorTaggedSequent;
...
(function($PS) {
      ...
      return function (form) {
          var p = function (prec$prime) {
              return function (s) {
                  ...
                  throw new Error("Failed pattern match at CLL2 (line 237, column 9 - line 240, column 1): " + [ prec$prime.constructor.name, s.constructor.name ]);
              };
          };
          ...
          throw new Error("Failed pattern match at CLL2 (line 221, column 20 - line 236, column 59): " + [ form.constructor.name ]);
      };
  };
  var ppFormH = function (prec) {
      return function ($304) {
          return Spork_Html_Core.text(ppForm(prec)($304));
      };
  };
  ...
  var freshen = function ($copy_a) {
      return function ($copy_from) {
          ...
          function $tco_loop(a, from) {
              if (Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function ($305) {
                  return !freeInForm(a)($305);
              })(from)) {
                  $tco_done = true;
                  return a;
              };
          ...
          var v2 = function (v3) {
              if (v.value0.button instanceof Derivation.LeftButton && v1 instanceof Derivation.LeftNG) {
                  ...
                  if (v1["value0"]["new"] instanceof With) {
                      ...
                      throw new Error("Failed pattern match at CLL2 (line 110, column 17 - line 112, column 78): " + [ v.value0.mpart.constructor.name ]);
                  };
                  ...
                  if (v1["value0"]["new"] instanceof Ofc) {
                      ...
                      throw new Error("Failed pattern match at CLL2 (line 115, column 14 - line 118, column 65): " + [ v.value0.mpart.constructor.name ]);
                  };
                  ...
                  if (v1["value0"]["new"] instanceof Forall2) {
                      ...
                      throw new Error("Failed pattern match at CLL2 (line 123, column 20 - line 125, column 75): " + [ v.value1.constructor.name ]);
                  };
                  ...
                  throw new Error("Failed pattern match at CLL2 (line 100, column 3 - line 128, column 68): " + [ v1["value0"]["new"].constructor.name ]);
              };
              if (v.value0.button instanceof Derivation.LeftButton && v1 instanceof Derivation.RightNG) {
                  ...
                  if (v1["value0"]["new"] instanceof Plus) {
                      ...
                      throw new Error("Failed pattern match at CLL2 (line 139, column 17 - line 141, column 78): " + [ v.value0.mpart.constructor.name ]);
                  };
                  if (v1["value0"]["new"] instanceof With) {
                  ...
                  if (v1["value0"]["new"] instanceof Ynot) {
                      ...
                      throw new Error("Failed pattern match at CLL2 (line 149, column 15 - line 152, column 65): " + [ v.value0.mpart.constructor.name ]);
                  };
                  if (v1["value0"]["new"] instanceof Impl) {
                  ...
                  if (v1["value0"]["new"] instanceof Exists2) {
                      ...
                      throw new Error("Failed pattern match at CLL2 (line 157, column 20 - line 159, column 75): " + [ v.value1.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at CLL2 (line 131, column 3 - line 159, column 75): " + [ v1["value0"]["new"].constructor.name ]);
              };
  ...
  var cllCalculus = new Derivation.Calculus(function () {
      return eqForm;
  }, formParser, pickRule);
  exports["Atom"] = Atom;
  exports["Neg"] = Neg;
...
(function($PS) {
      ...
      return function (form) {
          var p = function (prec$prime) {
              return function (s) {
                  ...
                  throw new Error("Failed pattern match at LK (line 92, column 9 - line 95, column 1): " + [ prec$prime.constructor.name, s.constructor.name ]);
              };
          };
          if (form instanceof Atom) {
              return form.value0;
  ...
  var ppFormH = function (prec) {
      return function ($156) {
          return Spork_Html_Core.text(ppForm(prec)($156));
      };
  };
  var renderForm = function (seqix) {
      return function (v) {
  ...
  var lkCalculus = new Derivation.Calculus(function () {
      return eqForm;
  }, formParser, pickRule);
  exports["Atom"] = Atom;
  exports["Impl"] = Impl;
...
(function($PS) {
  ...
  var ljCalculus = new Derivation.Calculus(function () {
      return eqForm;
  }, function (v) {
          ...
          return function (p) {
              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_State_Trans.monadStateT(dictMonad)))(Control_Monad_State_Class.get(Control_Monad_Except_Trans.monadStateExceptT(Control_Monad_State_Trans.monadStateStateT(dictMonad))))(function (v) {
                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_State_Trans.monadStateT(dictMonad)))(Data_Newtype.un(Text_Parsing_Parser.newtypeParserT)(Text_Parsing_Parser.ParserT)(p))(function (v1) {
                      ...
                      throw new Error("Failed pattern match at URI.Common (line 56, column 3 - line 58, column 21): " + [ v2.constructor.name ]);
                  });
              });
          };
      };
  ...
  var printEncoded = function (p) {
      return function (s) {
          ...
          var encodedChar = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function ($27) {
              return Global_Unsafe.unsafeEncodeURIComponent(Data_String_CodeUnits.singleton($27));
  ...
  var pctEncoded = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("%"))(function (v) {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Token.hexDigit(Data_Identity.monadIdentity))(function (v1) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Token.hexDigit(Data_Identity.monadIdentity))(function (v2) {
              return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(Data_Semigroup.append(Data_String_NonEmpty_Internal.semigroupNonEmptyString)(Data_String_NonEmpty_CodeUnits.singleton(v))(Data_Semigroup.append(Data_String_NonEmpty_Internal.semigroupNonEmptyString)(Data_String_NonEmpty_CodeUnits.singleton(v1))(Data_String_NonEmpty_CodeUnits.singleton(v2))));
          });
      });
  });
...
(function($PS) {
  ...
  var parser = Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("?"))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(function ($8) {
      return Query(Data_String_NonEmpty_Internal.joinWith(Data_Foldable.foldableArray)("")($8));
...
(function($PS) {
  ...
  var parsePart = function (parseK) {
      return function (parseV) {
          ...
          })(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_String_NonEmpty_Internal.joinWith(Data_Foldable.foldableArray)(""))(Data_Array.some(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_String_NonEmpty_CodeUnits.singleton)(keyPartChar))(URI_Common.pctEncoded)))))(function (v) {
  ...
  exports["parse"] = parse;
  exports["keyPartChar"] = keyPartChar;
  exports["valuePartChar"] = valuePartChar;
...
(function($PS) {
          ...
          return function (v1) {
              ...
              if (v1 instanceof Submit) {
                  ...
                  if (v2 instanceof Data_Either.Left) {
                      ...
                      throw new Error("Failed pattern match at Main (line 80, column 15 - line 82, column 65): " + [ v3.constructor.name ]);
                  };
                  if (v2 instanceof Data_Either.Right) {
                      return {
                          input: "",
                  ...
                  throw new Error("Failed pattern match at Main (line 79, column 29 - line 83, column 49): " + [ v2.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main (line 75, column 1 - line 76, column 42): " + [ v.constructor.name, v1.constructor.name ]);
          };
      };
  };
  ...
  var main = function __do() {
      ...
      return Effect_Exception.catchException(function ($47) {
          return Data_Function.flip(Web_HTML_Window.alert)(win)(Effect_Exception.message($47));
      })(function __do() {
          var v = Web_HTML_Window.location(win)();
          var v1 = Web_HTML_Location.search(v)();
          var v2 = Data_Either.either(function (v2) {
              return Effect_Exception["throw"]("no query string or bad query string");
          })(Control_Applicative.pure(Effect.applicativeEffect))(Text_Parsing_Parser.runParser(v1)(URI_Query.parser))();
          var v3 = Data_Either.either(function (v3) {
              return Effect_Exception["throw"]("could not parse query string");
          })(Control_Applicative.pure(Effect.applicativeEffect))(URI_Extra_QueryPairs.parse(Control_Applicative.pure(Data_Either.applicativeEither))(Control_Applicative.pure(Data_Either.applicativeEither))(v2))();
          var k = URI_Extra_QueryPairs.keyFromString("system");
          var mv = Data_Functor.map(Data_Maybe.functorMaybe)(URI_Extra_QueryPairs.valueToString)(Data_Foldable.findMap(Data_Foldable.foldableArray)(function (v4) {
              var $40 = Data_Eq.eq(URI_Extra_QueryPairs.eqKey)(v4.value0)(k);
              if ($40) {
                  return v4.value1;
              };
              return Data_Maybe.Nothing.value;
