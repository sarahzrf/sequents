...
(function($PS) {
  ...
  var functorPickAction = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          throw new Error("Failed pattern match at Derivation (line 201, column 8 - line 201, column 56): " + [ m.constructor.name ]);
      };
  });
  var functorNodeAction = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          throw new Error("Failed pattern match at Derivation (line 258, column 8 - line 258, column 56): " + [ m.constructor.name ]);
      };
  });
  var functorExplodedSequent = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          throw new Error("Failed pattern match at Derivation (line 142, column 8 - line 142, column 66): " + [ m.constructor.name ]);
      };
  });
  ...
  var explodeNG = function (v) {
      ...
      throw new Error("Failed pattern match at Derivation (line 155, column 3 - line 163, column 3): " + [ v2.constructor.name, v1.constructor.name ]);
  };
  ...
  var explodeG = function (v) {
      ...
      throw new Error("Failed pattern match at Derivation (line 172, column 3 - line 180, column 3): " + [ v2.constructor.name, v1.constructor.name ]);
  };
  var enew = function (v) {
...
(function($PS) {
      ...
      return function (form) {
          var p = function (prec$prime) {
              return function (s) {
                  ...
                  throw new Error("Failed pattern match at CLL2 (line 261, column 9 - line 264, column 1): " + [ prec$prime.constructor.name, s.constructor.name ]);
              };
          };
  ...
  var ppFormH = function (prec) {
      return function ($342) {
          return Spork_Html_Core.text(ppForm(prec)($342));
      };
  };
  ...
  var freshen = function ($copy_a) {
      return function ($copy_from) {
          ...
          function $tco_loop(a, from) {
              if (Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function ($343) {
                  return !freeInForm(a)($343);
              })(from)) {
                  $tco_done = true;
                  return a;
              };
...
(function($PS) {
      ...
      return function (form) {
          var p = function (prec$prime) {
              return function (s) {
                  ...
                  throw new Error("Failed pattern match at RCLL2 (line 229, column 9 - line 232, column 1): " + [ prec$prime.constructor.name, s.constructor.name ]);
              };
          };
          if (form instanceof Atom) {
              return form.value0;
  ...
  var ppFormH = function (prec) {
      return function ($272) {
          return Spork_Html_Core.text(ppForm(prec)($272));
      };
  };
  var renderForm = function (seqix) {
      return function (v) {
  ...
  var freshen = function ($copy_a) {
      return function ($copy_from) {
          ...
          var $tco_result;
          function $tco_loop(a, from) {
              if (Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function ($273) {
                  return !freeInForm(a)($273);
              })(from)) {
                  $tco_done = true;
                  return a;
              };
...
(function($PS) {
  ...
  var sequentParser = function (dictCalculus) {
      ...
      return Control_Bind.bind(Text_Parsing_StringParser.bindParser)(Control_Apply.apply(Text_Parsing_StringParser.applyParser)(Data_Functor.map(Text_Parsing_StringParser.functorParser)(Derivation.unitaggedEntails)(forms))(Control_Apply.applySecond(Text_Parsing_StringParser.applyParser)(Text_Parsing_StringParser_CodePoints.string("|-"))(forms)))(function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(Control_MonadZero.guard(Text_Parsing_StringParser.monadZeroParser)(Derivation.okInitial(dictCalculus)(v)))(function () {
              return Control_Applicative.pure(Text_Parsing_StringParser.applicativeParser)(v);
          });
      });
  };
          ...
          return function (v1) {
              ...
              if (v1 instanceof Submit) {
                  ...
                  if (v2 instanceof Data_Either.Left) {
                      ...
                      throw new Error("Failed pattern match at Main (line 92, column 15 - line 94, column 65): " + [ v3.constructor.name ]);
                  };
                  if (v2 instanceof Data_Either.Right) {
                      return {
                          input: "",
                  ...
                  throw new Error("Failed pattern match at Main (line 91, column 29 - line 95, column 49): " + [ v2.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main (line 87, column 1 - line 88, column 42): " + [ v.constructor.name, v1.constructor.name ]);
          };
      };
  };
  ...
  var main = function __do() {
      ...
      return Effect_Exception.catchException(function ($51) {
          return Data_Function.flip(Web_HTML_Window.alert)(win)(Effect_Exception.message($51));
      })(function __do() {
          ...
          var mv = Data_Functor.map(Data_Maybe.functorMaybe)(URI_Extra_QueryPairs.valueToString)(Data_Foldable.findMap(Data_Foldable.foldableArray)(function (v4) {
              var $43 = Data_Eq.eq(URI_Extra_QueryPairs.eqKey)(v4.value0)(k);
              if ($43) {
                  return v4.value1;
              };
              return Data_Maybe.Nothing.value;
