...
(function(exports) {
      ...
      return function (form) {
          var p = function (prec$prime) {
              return function (s) {
                  ...
                  throw new Error("Failed pattern match at Derivation line 382, column 9 - line 385, column 1: " + [ prec$prime.constructor.name, s.constructor.name ]);
              };
          };
          ...
          throw new Error("Failed pattern match at Derivation line 376, column 20 - line 381, column 35: " + [ form.constructor.name ]);
      };
  };
  var ppFormH = function (prec) {
      return function ($347) {
          return Spork_Html_Core.text(ppForm(prec)($347));
      };
  };
  ...
  var mapTags = function ($348) {
      return mapTagsI(Data_Function["const"]($348));
  };
  var unitaggedConc = function (v) {
      ...
      throw new Error("Failed pattern match at Derivation line 244, column 1 - line 244, column 34: " + [ v.constructor.name ]);
  };
  var intersperse = function (sep) {
      return function (arr) {
          ...
          throw new Error("Failed pattern match at Derivation line 330, column 23 - line 333, column 59: " + [ v.constructor.name ]);
      };
  };
  ...
  var explodeNG = function (v) {
      ...
      var splitAtNew = function (forms) {
          ...
          var $119 = Data_Array.span(function (v2) {
              return Data_Eq.notEq(eqNGTag)(v2.tag)(NewFormNG.value);
          })(forms);
          var $120 = Data_Array.uncons($119.rest);
          if ($120 instanceof Data_Maybe.Just) {
              var $121 = Data_Eq.eq(eqNGTag)($120.value0.head.tag)(NewFormNG.value);
              if ($121) {
                  return new Data_Maybe.Just({
                      init: $119.init,
                      head: $120.value0.head,
                      tail: $120.value0.tail
                  });
              };
              return v1(true);
          };
  ...
  var explodeG = function (v) {
      ...
      var splitAtNew = function (forms) {
          ...
          var $146 = Data_Array.span(function (v2) {
              return Data_Eq.notEq(eqGTag)(v2.tag)(NewFormG.value);
          })(forms);
          var $147 = Data_Array.uncons($146.rest);
          if ($147 instanceof Data_Maybe.Just) {
              var $148 = Data_Eq.eq(eqGTag)($147.value0.head.tag)(NewFormG.value);
              if ($148) {
                  return new Data_Maybe.Just({
                      init: $146.init,
                      head: $147.value0.head,
                      tail: $147.value0.tail
                  });
              };
              return v1(true);
          };
  ...
  var complete = function (v) {
      ...
      throw new Error("Failed pattern match at Derivation line 249, column 1 - line 249, column 29: " + [ v.constructor.name ]);
  };
  var clickable = function (clss) {
      return function (act) {
          ...
          return Spork_Html_Elements.span([ Spork_Html_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "clickable" ])(clss)), Spork_Html_Events.onMouseDown(function ($349) {
              return Data_Functor.map(Data_Maybe.functorMaybe)(act)(buttonFor($349));
          }) ]);
      };
  };
  var renderForm = function (seqix) {
      return function (v) {
          ...
          var clss = (function () {
              var $204 = Data_Eq.eq(eqRenderTag)(v.tag)(NewFormR.value);
              if ($204) {
                  return [ "new" ];
              };
              return [  ];
  ...
  var renderSequent = function (v) {
      var turnstile = clickable([  ])(function ($350) {
          ...
          if (prf instanceof Conclusion) {
              return [ (function () {
                  ...
                  var conc = (function () {
                      ...
                      throw new Error("Failed pattern match at Derivation line 323, column 18 - line 325, column 79: " + [ prf.value0.wconc.constructor.name ]);
                  })();
                  return Data_Functor.map(Spork_Html_Core.functorHtml)(NAction.create)(renderSequent(conc));
              })() ];
          };
          throw new Error("Failed pattern match at Derivation line 316, column 3 - line 326, column 43: " + [ prf.constructor.name ]);
      })());
  };
      ...
      return function ($copy_wconc) {
          ...
          function $tco_loop(rule, wconc) {
              var v = (function () {
                  ...
                  throw new Error("Failed pattern match at Derivation line 299, column 32 - line 303, column 74: " + [ wconc.constructor.name ]);
              })();
              ...
              throw new Error("Failed pattern match at Derivation line 294, column 24 - line 298, column 57: " + [ v1.constructor.name ]);
          };
          while (!$tco_done) {
  ...
  var updateNode = function (prf) {
      return function (v) {
          ...
          var v1 = function (v2) {
                  ...
                  return Data_Maybe.fromMaybe(prf)((function () {
                      if (prf instanceof Conclusion && prf.value0.wconc instanceof ConcG) {
                          var chtag = function (seqix$prime) {
                              var $320 = Data_Eq.eq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                                  return "side";
                      ...
                      var chtag = function (seqix$prime) {
                          return function (v3) {
                              var $325 = Data_Eq.eq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                                  return "side";
                              }))(eqSeqSide))()(new Data_Symbol.IsSymbol(function () {
                                  return "ix";
                              }))(Data_Eq.eqInt)))(seqix$prime)(v.value0.seqix);
              ...
              throw new Error("Failed pattern match at Derivation line 266, column 1 - line 266, column 43: " + [ prf.constructor.name, v.constructor.name ]);
          };
          if (v instanceof ClickedTurnstile && v.value0.button instanceof LeftButton) {
              var $331 = unitaggedConc(prf);
              if ($331.value0.length === 1 && $331.value1.length === 1) {
                  var $332 = Data_Eq.eq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                      ...
                      return "form";
                  }))(eqForm)))($331["value0"][0])($331["value1"][0]);
                  if ($332) {
                      return new Conclusion({
                          subprfs: [  ],
                          rule: v.value0,
                          wconc: new ConcNG(new Entails([ {
                              form: $331["value0"][0].form,
                              tag: SideFormNG.value
                          } ], [ {
                              form: $331["value1"][0].form,
                              tag: NewFormNG.value
                          } ]))
                      });
                  };
  ...
  var update = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Derivation line 259, column 1 - line 259, column 35: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  exports["Atom"] = Atom;
  exports["Impl"] = Impl;
