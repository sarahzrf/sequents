...
(function(exports) {
      ...
      return function (form) {
          var p = function (prec$prime) {
              return function (s) {
                  ...
                  throw new Error("Failed pattern match at Derivation line 390, column 9 - line 393, column 1: " + [ prec$prime.constructor.name, s.constructor.name ]);
              };
          };
          ...
          throw new Error("Failed pattern match at Derivation line 384, column 20 - line 389, column 35: " + [ form.constructor.name ]);
      };
  };
  var ppFormH = function (prec) {
      return function ($354) {
          return Spork_Html_Core.text(ppForm(prec)($354));
      };
  };
  var ngTag = function ($$new) {
      return function (side) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Derivation line 81, column 1 - line 81, column 40: " + [ $$new.constructor.name, side.constructor.name, v.constructor.name ]);
          };
      };
  };
  ...
  var mapTags = function ($355) {
      return mapTagsI(Data_Function["const"]($355));
  };
  var unitaggedConc = function (v) {
      ...
      throw new Error("Failed pattern match at Derivation line 252, column 1 - line 252, column 34: " + [ v.constructor.name ]);
  };
  var intersperse = function (sep) {
      return function (arr) {
          ...
          throw new Error("Failed pattern match at Derivation line 338, column 23 - line 341, column 59: " + [ v.constructor.name ]);
      };
  };
      ...
      return function (side1) {
          return function (side2) {
              return function (v) {
                  ...
                  throw new Error("Failed pattern match at Derivation line 85, column 1 - line 85, column 43: " + [ $$new.constructor.name, side1.constructor.name, side2.constructor.name, v.constructor.name ]);
              };
          };
      };
  };
  ...
  var explodeNG = function (v) {
      ...
      var splitAtNew = function (forms) {
          var v1 = function (v2) {
              ...
              throw new Error("Failed pattern match at Derivation line 138, column 1 - line 138, column 52: " + [ forms.constructor.name ]);
          };
          var $121 = Data_Array.span(function (v2) {
              return Data_Eq.notEq(eqNGTag)(v2.tag)(NewFormNG.value);
          })(forms);
          var $122 = Data_Array.uncons($121.rest);
          if ($122 instanceof Data_Maybe.Just) {
              var $123 = Data_Eq.eq(eqNGTag)($122.value0.head.tag)(NewFormNG.value);
              if ($123) {
                  return new Data_Maybe.Just({
                      init: $121.init,
                      head: $122.value0.head,
                      tail: $122.value0.tail
                  });
              };
              return v1(true);
          };
      ...
      throw new Error("Failed pattern match at Derivation line 140, column 3 - line 148, column 3: " + [ v2.constructor.name, v1.constructor.name ]);
  };
  ...
  var explodeG = function (v) {
      ...
      var splitAtNew = function (forms) {
          var v1 = function (v2) {
              ...
              throw new Error("Failed pattern match at Derivation line 155, column 1 - line 155, column 50: " + [ forms.constructor.name ]);
          };
          var $148 = Data_Array.span(function (v2) {
              return Data_Eq.notEq(eqGTag)(v2.tag)(NewFormG.value);
          })(forms);
          var $149 = Data_Array.uncons($148.rest);
          if ($149 instanceof Data_Maybe.Just) {
              var $150 = Data_Eq.eq(eqGTag)($149.value0.head.tag)(NewFormG.value);
              if ($150) {
                  return new Data_Maybe.Just({
                      init: $148.init,
                      head: $149.value0.head,
                      tail: $149.value0.tail
                  });
              };
              return v1(true);
          };
      ...
      throw new Error("Failed pattern match at Derivation line 157, column 3 - line 165, column 3: " + [ v2.constructor.name, v1.constructor.name ]);
  };
  ...
  var enew = function (v) {
      ...
      throw new Error("Failed pattern match at Derivation line 130, column 8 - line 134, column 23: " + [ v.constructor.name ]);
  };
  var complete = function (v) {
      ...
      throw new Error("Failed pattern match at Derivation line 257, column 1 - line 257, column 29: " + [ v.constructor.name ]);
  };
  var clickable = function (clss) {
      return function (act) {
          ...
          return Spork_Html_Elements.span([ Spork_Html_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "clickable" ])(clss)), Spork_Html_Events.onMouseDown(function ($356) {
              return Data_Functor.map(Data_Maybe.functorMaybe)(act)(buttonFor($356));
          }) ]);
      };
  };
  var renderForm = function (seqix) {
      return function (v) {
          ...
          var clss = (function () {
              var $206 = Data_Eq.eq(eqRenderTag)(v.tag)(NewFormR.value);
              if ($206) {
                  return [ "new" ];
              };
              return [  ];
  ...
  var renderSequent = function (v) {
      var turnstile = clickable([  ])(function ($357) {
          ...
          if (prf instanceof Conclusion) {
              return [ (function () {
                  ...
                  var conc = (function () {
                      ...
                      throw new Error("Failed pattern match at Derivation line 331, column 18 - line 333, column 79: " + [ prf.value0.wconc.constructor.name ]);
                  })();
                  return Data_Functor.map(Spork_Html_Core.functorHtml)(NAction.create)(renderSequent(conc));
              })() ];
          };
          throw new Error("Failed pattern match at Derivation line 324, column 3 - line 334, column 43: " + [ prf.constructor.name ]);
      })());
  };
  var byPart = function (x) {
      return function (y) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Derivation line 107, column 1 - line 107, column 44: " + [ x.constructor.name, y.constructor.name, v.constructor.name ]);
          };
      };
  };
  var pickRule = function (v) {
      return function (v1) {
          if (v.button instanceof RightButton && v1 instanceof LeftNG) {
          ...
          if (v.button instanceof RightButton && v1 instanceof RightNG) {
          ...
          if (v.button instanceof MiddleButton && v1 instanceof LeftNG) {
          ...
          if (v.button instanceof MiddleButton && v1 instanceof RightNG) {
          ...
          var v2 = function (v3) {
              if (v.button instanceof LeftButton && v1 instanceof LeftNG) {
                  if (v1["value0"]["new"] instanceof Conj) {
                      ...
                      throw new Error("Failed pattern match at Derivation line 201, column 17 - line 203, column 78: " + [ v.mpart.constructor.name ]);
                  };
              ...
              if (v.button instanceof LeftButton && v1 instanceof RightNG) {
                  ...
                  if (v1["value0"]["new"] instanceof Disj) {
                      ...
                      throw new Error("Failed pattern match at Derivation line 215, column 17 - line 217, column 78: " + [ v.mpart.constructor.name ]);
                  };
                  if (v1["value0"]["new"] instanceof Neg) {
  ...
  var pickRuleInt = function (rule) {
      return function (eseq) {
          var v = pickRule(rule)(eseq);
          if (v instanceof Obligations) {
      ...
      return function ($copy_wconc) {
          ...
          function $tco_loop(rule, wconc) {
              var v = (function () {
                  ...
                  throw new Error("Failed pattern match at Derivation line 307, column 32 - line 311, column 74: " + [ wconc.constructor.name ]);
              })();
              var v1 = pickRuleInt(rule)(v.value0);
              ...
              throw new Error("Failed pattern match at Derivation line 302, column 24 - line 306, column 57: " + [ v1.constructor.name ]);
          };
          while (!$tco_done) {
  ...
  var updateNode = function (prf) {
      return function (v) {
          ...
          var v1 = function (v2) {
                  ...
                  return Data_Maybe.fromMaybe(prf)((function () {
                      if (prf instanceof Conclusion && prf.value0.wconc instanceof ConcG) {
                          var chtag = function (seqix$prime) {
                              var $327 = Data_Eq.eq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                                  return "side";
                      ...
                      var chtag = function (seqix$prime) {
                          return function (v3) {
                              var $332 = Data_Eq.eq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                                  return "side";
                              }))(eqSeqSide))()(new Data_Symbol.IsSymbol(function () {
                                  return "ix";
                              }))(Data_Eq.eqInt)))(seqix$prime)(v.value0.seqix);
              ...
              throw new Error("Failed pattern match at Derivation line 274, column 1 - line 274, column 43: " + [ prf.constructor.name, v.constructor.name ]);
          };
          if (v instanceof ClickedTurnstile && v.value0.button instanceof LeftButton) {
              var $338 = unitaggedConc(prf);
              if ($338.value0.length === 1 && $338.value1.length === 1) {
                  var $339 = Data_Eq.eq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                      return "tag";
                  }))(Data_Eq.eqUnit))()(new Data_Symbol.IsSymbol(function () {
                      return "form";
                  }))(eqForm)))($338["value0"][0])($338["value1"][0]);
                  if ($339) {
                      return new Conclusion({
                          subprfs: [  ],
                          rule: v.value0,
                          wconc: new ConcNG(new Entails([ {
                              form: $338["value0"][0].form,
                              tag: SideFormNG.value
                          } ], [ {
                              form: $338["value1"][0].form,
                              tag: NewFormNG.value
                          } ]))
                      });
                  };
  ...
  var update = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Derivation line 267, column 1 - line 267, column 35: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  exports["Atom"] = Atom;
  exports["Impl"] = Impl;
  ...
  exports["pickRuleInt"] = pickRuleInt;
...
(function(exports) {
  ...
  var table = (function () {
      ...
      return [ [ new Text_Parsing_StringParser_Expr.Prefix(Data_Functor.voidRight(Text_Parsing_StringParser.functorParser)(Derivation.Neg.create)(spaced("~"))) ], [ new Text_Parsing_StringParser_Expr.Infix(Data_Functor.voidRight(Text_Parsing_StringParser.functorParser)(Derivation.Conj.create)(spaced("/\\")), Text_Parsing_StringParser_Expr.AssocRight.value), new Text_Parsing_StringParser_Expr.Infix(Data_Functor.voidRight(Text_Parsing_StringParser.functorParser)(Derivation.Disj.create)(spaced("\\/")), Text_Parsing_StringParser_Expr.AssocRight.value) ], [ new Text_Parsing_StringParser_Expr.Infix(Data_Functor.voidRight(Text_Parsing_StringParser.functorParser)(Derivation.Impl.create)(spaced("->")), Text_Parsing_StringParser_Expr.AssocRight.value) ] ];
  })();
  ...
  var expr = function (v) {
      return Control_Alt.alt(Text_Parsing_StringParser.altParser)(Control_Apply.applyFirst(Text_Parsing_StringParser.applyParser)(Control_Apply.applySecond(Text_Parsing_StringParser.applyParser)(Text_Parsing_StringParser_CodePoints["char"]("("))(Control_Lazy.defer(Text_Parsing_StringParser.lazyParser)(formParser)))(Text_Parsing_StringParser_CodePoints["char"](")")))(Data_Functor.map(Text_Parsing_StringParser.functorParser)(Derivation.Atom.create)(Text_Parsing_StringParser_CodePoints.regex("\\w+")));
  };
...
(function(exports) {
  ...
  var update = function (v) {
      return function (v1) {
          ...
          if (v1 instanceof Submit) {
              ...
              if (v2 instanceof Data_Either.Right) {
                  if (Data_Array.length(v2.value0.value1) <= 1) {
                      return {
                          input: "",
              ...
              throw new Error("Failed pattern match at Main line 36, column 29 - line 42, column 23: " + [ v2.constructor.name ]);
          };
  ...
  var init = {
      input: "",
      prf: Derivation.Assertion.create(Derivation.unitaggedEntails([  ])([ new Derivation.Impl(new Derivation.Impl(new Derivation.Impl(new Derivation.Atom("P"), new Derivation.Atom("Q")), new Derivation.Atom("P")), new Derivation.Atom("P")) ]))
  };
  var main = (function () {
      var app = {
          init: init,
